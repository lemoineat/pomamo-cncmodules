...
{
  /// <summary>
  /// Implements the TONR instruction
  /// 
  /// The TONR instruction is non-retentive timer that accumulates time when TimerEnable is set
  /// </summary>
  public sealed class TimerOnDelayWithReset : Lemoine.Cnc.BaseCncModule, Lemoine.Cnc.ICncModule, IDisposable
  {
    #region Members
    ...
    /// </summary>
    public TimerOnDelayWithReset ()
      : base ("Lemoine.Cnc.InOut.TimerOnDelayWithReset")
    {
    }
